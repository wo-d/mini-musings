...
- A tripod (or some stationary surface which you know the camera will not move, this is important because we really need to slow down the shutter speed)
...
With the second image I've zoomed the camera out some and refocused. Because I'm using a DSLR, and it has a large DPI the captured image is still very crisp and detailed. Unfortunately I still have the light directly over the model and there is still a pronounced shadow.

![Image 2](./take_2.jpg)

### Image 3

Finally, I've moved the main light source and just look at that! While the model is not entirely uniformly lit, the shadows it does have read realistically and compliments my paint job.
...
With a proper setup and some trial and error miniature photography can be a fun and rewarding exercise! Hopefully I left you learning something new, and at the very least I have a nice reference for the future. For now, I leave you with a photo of the chief librarian<sup>1</sup> himself.
